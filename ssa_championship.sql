...
CREATE TABLE IF NOT EXISTS `event_info` (
  ...
  `org_name`            VARCHAR(300) NOT NULL DEFAULT 'Saragarhi Shooting Academy',
...
CREATE TABLE IF NOT EXISTS `custom_weapon_types` (
  ...
  `weapon_label` VARCHAR(200) NULL DEFAULT NULL,
  `created_at`   DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `lane_allocations` (
  ...
  `target_serial_no` VARCHAR(50)  NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `teams` (
  ...
  `club_name`   VARCHAR(200) NULL DEFAULT NULL,
...
-- Event Info Seeding
INSERT INTO `event_info` (`id`, `event_code`, `event_title`, `org_name`, `event_date`, `venue`, `last_seq`) VALUES (1, 'SSA51TN', '51st Tamil Nadu Shooting Championship', 'Saragarhi Shooting Academy', NULL, NULL, 0) ON DUPLICATE KEY UPDATE `event_title` = VALUES(`event_title`), `org_name` = VALUES(`org_name`), `event_date` = VALUES(`event_date`), `venue` = VALUES(`venue`);
