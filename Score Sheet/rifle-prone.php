...
$eventIdVal = $getEventId($alloc, $EVENTS_MAPPING, 'IS-61');
...
// Fetch document template customization for score_sheet_rifle_prone
$tplStmt = $pdo->prepare("SELECT canvas_data, background_path FROM document_templates WHERE document_type = 'score_sheet_rifle_prone' LIMIT 1");
$tplStmt->execute();
...
<head>
  ...
  <title>50M Rifle Prone — Saragarhi Shooting Academy</title>
...
<div class="sheet-page">
  ...
  <section class="score-card">
    <div class="score-card-header">
      ...
      <span class="badge">Prone Position Event</span>
    </div>
